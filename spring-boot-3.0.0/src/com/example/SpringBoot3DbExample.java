...
public class SpringBoot3DbExample {

    static final Logger logger = LoggerFactory.getLogger(SpringBoot3DbExample.class);

    public static void main(String[] args) {
        SpringApplication.run(SpringBoot3DbExample.class, args);
    }
